...
export function WhatsappFloat() {
  return (
    ...
    >
      ...
      />
      <span
        className="ring-pulse pointer-events-none absolute inset-0 rounded-full bg-brand-green [animation-delay:1.1s]"
        aria-hidden
      />
      <svg viewBox="0 0 24 24" className="relative z-10 size-7" aria-hidden="true">
        <path
          fill="currentColor"
